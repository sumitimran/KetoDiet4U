...
export const metadata: Metadata = {
  title: "Ultimate Keto Breakfast Bowl Recipe - High Protein & Low Carb",
  description:
    "Start your day with this delicious keto breakfast bowl packed with eggs, avocado, and greens. Ready in 15 minutes with only 4g net carbs. Includes nutritional info and meal prep tips.",
  keywords: [
    "keto breakfast",
  ...
  openGraph: {
    title: "Ultimate Keto Breakfast Bowl Recipe - High Protein & Low Carb",
    description: "Start your day with this delicious keto breakfast bowl. Ready in 15 minutes with only 4g net carbs.",
    type: "article",
    ...
    images: [
      {
        url: "https://ketodiet4u.com/keto-breakfast-bowl-with-avocado-and-eggs.jpg",
        width: 1200,
        height: 630,
        alt: "Ultimate Keto Breakfast Bowl with eggs and avocado",
      },
    ],
  },
  twitter: {
    ...
    title: "Ultimate Keto Breakfast Bowl Recipe - High Protein & Low Carb",
    description: "Start your day with this delicious keto breakfast bowl. Ready in 15 minutes with only 4g net carbs.",
    images: ["https://ketodiet4u.com/keto-breakfast-bowl-with-avocado-and-eggs.jpg"],
  },
}
...
export default function UltimateKetoBreakfastBowl() {
  const jsonLd = {
    ...
    "@type": "Recipe",
    name: "Ultimate Keto Breakfast Bowl",
    description:
      "A protein-packed, nutrient-dense keto breakfast bowl with eggs, avocado, and greens that keeps you satisfied for hours.",
    image: "https://ketodiet4u.com/keto-breakfast-bowl-with-avocado-and-eggs.jpg",
    author: {
      "@type": "Organization",
    ...
    recipeCuisine: "Ketogenic",
    keywords: "keto, breakfast bowl, low carb, high protein, eggs, avocado",
    nutrition: {
    ...
    recipeInstructions: [
      {
        "@type": "HowToStep",
        text: "Wash spinach or mixed greens. Use raw or sauté in butter for 1-2 minutes.",
      },
      {
        "@type": "HowToStep",
        text: "Heat skillet over medium heat with butter. Cook eggs scrambled or fried, season with salt and pepper.",
      },
      {
        "@type": "HowToStep",
        text: "Place greens in a bowl, add cooked eggs and sliced avocado.",
      },
      {
        "@type": "HowToStep",
        text: "Add optional toppings like bacon, cheese, sour cream, and fresh herbs.",
      },
    ],
    aggregateRating: {
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="container text-center space-y-4">
              ...
              <div className="flex items-center justify-center gap-6 text-muted-foreground">
                <time dateTime="2024-12-20" className="flex items-center gap-2">
        ...
        <div className="container max-w-4xl py-12">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-muted-foreground leading-relaxed">
              Start your day right with this protein-packed, nutrient-dense breakfast that keeps you satisfied for
              hours.
            </p>
            ...
            <p className="leading-relaxed">
              Start by washing your spinach or mixed greens thoroughly. You can use them raw for a fresh, crunchy
              texture, or quickly sauté them in a bit of butter for 1-2 minutes until just wilted. If sautéing, add a
            ...
            <p className="leading-relaxed">
              ...
              foaming, crack your eggs directly into the pan. For scrambled eggs, whisk them first and pour into the
              pan, stirring gently until creamy. For fried eggs, cook until the whites are set but the yolks remain
              runny (about 3-4 minutes). Season generously with salt and pepper.
            </p>
            ...
            <Card className="my-6 bg-primary/5">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Don't overcook your eggs! Remove them from heat when they're slightly underdone—they'll continue
                  cooking from residual heat. This keeps them soft, creamy, and delicious.
                </p>
              </CardContent>
            </Card>
            ...
            <p className="leading-relaxed">
              Start with your greens as a base in a wide, shallow bowl. This creates a bed for all the other
              ingredients. Add your cooked eggs on one side, and arrange your sliced avocado on the other. The visual
              contrast makes the bowl more appetizing and Instagram-worthy!
            </p>

            <h3 className="text-2xl font-semibold mt-8 mb-4">Step 4: Add Your Favorite Toppings</h3>
            <p className="leading-relaxed">
              This is where you can get creative! Crumble crispy bacon over the top, sprinkle with cheese, add a dollop
              of sour cream, and finish with fresh herbs. A drizzle of hot sauce adds a nice kick, and everything bagel
